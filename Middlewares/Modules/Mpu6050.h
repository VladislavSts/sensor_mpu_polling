...
class MPU6050Sensor {
private:
//	const ConfigI2C_t* I2c;
//	MPU6050_t* DataMpu;

public:
//	MPU6050Sensor(const ConfigI2C_t* I2c, MPU6050_t* DataMpu) : I2c(I2c), DataMpu(DataMpu) {}
...
//		HAL_I2C_Mem_Read(&I2c->I2cHandle, MPU6050_ADDR, WHO_AM_I_REG, 1, &check, 1, i2c_timeout);
//
//		if (check == 104)  // 0x68 will be returned by the sensor if everything goes well
//		{
//			// power management register 0X6B we should write all 0's to wake the sensor up
//			Data = 0;
//			HAL_I2C_Mem_Write(&I2c->I2cHandle, MPU6050_ADDR, PWR_MGMT_1_REG, 1, &Data, 1, i2c_timeout);
//
//			// Set DATA RATE of 1KHz by writing SMPLRT_DIV register
//			Data = 0x07;
//			HAL_I2C_Mem_Write(&I2c->I2cHandle, MPU6050_ADDR, SMPLRT_DIV_REG, 1, &Data, 1, i2c_timeout);
//
//			// Set accelerometer configuration in ACCEL_CONFIG Register
//			// XA_ST=0,YA_ST=0,ZA_ST=0, FS_SEL=0 -> � 2g
//			Data = 0x00;
//			HAL_I2C_Mem_Write(&I2c->I2cHandle, MPU6050_ADDR, ACCEL_CONFIG_REG, 1, &Data, 1, i2c_timeout);
//
//			// Set Gyroscopic configuration in GYRO_CONFIG Register
//			// XG_ST=0,YG_ST=0,ZG_ST=0, FS_SEL=0 -> � 250 �/s
//			Data = 0x00;
//			HAL_I2C_Mem_Write(&I2c->I2cHandle, MPU6050_ADDR, GYRO_CONFIG_REG, 1, &Data, 1, i2c_timeout);
//			return 0;
//		}
//		return 1;
//	}
...
//		HAL_I2C_Mem_Read(&I2c->I2cHandle, MPU6050_ADDR, ACCEL_XOUT_H_REG, 1, Rec_Data, 6, i2c_timeout);
//
...
//		HAL_I2C_Mem_Read(&I2c->I2cHandle, MPU6050_ADDR, GYRO_XOUT_H_REG, 1, Rec_Data, 6, i2c_timeout);
//
...
//		HAL_I2C_Mem_Read(&I2c->I2cHandle, MPU6050_ADDR, TEMP_OUT_H_REG, 1, Rec_Data, 2, i2c_timeout);
//
...
//		HAL_I2C_Mem_Read(&I2c->I2cHandle, MPU6050_ADDR, ACCEL_XOUT_H_REG, 1, Rec_Data, 14, i2c_timeout);
//
//		DataMpu->Accel_X_RAW = (int16_t) (Rec_Data[0] << 8 | Rec_Data[1]);
//		DataMpu->Accel_Y_RAW = (int16_t) (Rec_Data[2] << 8 | Rec_Data[3]);
//		DataMpu->Accel_Z_RAW = (int16_t) (Rec_Data[4] << 8 | Rec_Data[5]);
